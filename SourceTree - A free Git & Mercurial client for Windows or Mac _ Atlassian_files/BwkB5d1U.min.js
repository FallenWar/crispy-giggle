...
window.Demandbase.Config={clientId:"BwkB5d1U",key:"bbcf58a73a5204bb9615ac78df2f1b8d28193c98",nonCompanyDefault:null,nonWatchDefault:null,getDomain:null,conditions:null,segments:null,ads:{pixels:{ad:"1454097219",rt:"1454097268",cn:null}},analytics:{fieldMap:{1:"audience",2:"company_name",3:"industry",4:"revenue_range",5:"employee_range",6:"forbes_2000",8:"watch_list_Account_Type"}},isFormPage:null,forms:{key:null,companyID:null,emailID:null,fieldMap:null,toggleFieldList:null,priorityMap:null,fieldPrefix:null,
fieldSuffix:null,formNameList:null,autocompletePlaceholder:null}};"undefined"===typeof window.console&&(window.console={log:function(){},debug:function(){}});"undefined"===typeof window.localStorage&&(window.localStorage={getItem:function(){},setItem:function(){}});"undefined"===typeof JSON&&(JSON={stringify:function(){},parse:function(){}});
Array.prototype.indexOf||(Array.prototype.indexOf=function(h,f){var a=this.length>>>0,b=Number(f)||0,b=0>b?Math.ceil(b):Math.floor(b);for(0>b&&(b+=a);b<a;b++)if(b in this&&this[b]===h)return b;return-1});
Object.keys||(Object.keys=function(){var h=Object.prototype.hasOwnProperty,f=!{toString:null}.propertyIsEnumerable("toString"),a="toString toLocaleString valueOf hasOwnProperty isPrototypeOf propertyIsEnumerable constructor".split(" "),b=a.length;return function(c){if("object"!=typeof c&&("function"!=typeof c||null===c))throw new TypeError("Object.keys called on non-object");var d,e=[];for(d in c)h.call(c,d)&&e.push(d);if(f)for(d=0;b>d;d++)h.call(c,a[d])&&e.push(a[d]);return e}}());
Array.prototype.some||(Array.prototype.some=function(h){if(null==this)throw new TypeError("Array.prototype.some called on null or undefined");if("function"!==typeof h)throw new TypeError;for(var f=Object(this),a=f.length>>>0,b=2<=arguments.length?arguments[1]:void 0,c=0;c<a;c++)if(c in f&&h.call(b,f[c],c,f))return!0;return!1});
(function(h){function f(b){if(a[b])return a[b].exports;var c=a[b]={exports:{},id:b,loaded:!1};h[b].call(c.exports,c,c.exports,f);c.loaded=!0;return c.exports}var a={};f.m=h;f.c=a;f.p="/dist/scripts";return f(0)})([function(h,f){window.Demandbase.Config=window.Demandbase.Config||{};window.Demandbase.Config.hooks=window.Demandbase.Config.hooks||{};window.Demandbase.Connectors=window.Demandbase.Connectors||{};"function"!==typeof window.Demandbase.Config.hooks.onEctReady&&(window.Demandbase.Config.hooks.onEctReady=
...
"",e=a[b]||a[e]||c,c=(a.company_name||c)!==c,k=Object.keys(a).some(function(a){return 0===a.indexOf("watch_list_")});if(!1===a[b])return"false";-1!==b.indexOf("watch_list_")&&c&&(k||(d=window.Demandbase.Config.nonWatchDefault||window.Demandbase.utils.tokens.DFLT_NON_AW),e=a[b]||d);return e},getElementByIdOrName:function(a){var b=null;a&&((b=document.getElementById(a)||null)||(b=document.getElementsByName(a)[0]||null));return b},getQueryParam:function(a){var b={},c=window.location.search.substring(1),
d=c.split("&");if(!c)return"";for(c=0;c<d.length;c++){var e=d[c].split("=");b[e[0]]=e[1]}return b[a]||""},isCurrentPage:function(a,b){function c(a){return 0===a.indexOf("//")?a.substring(2,a.length):a.replace(/^.*?:\/\//g,"")}function d(a){-1!==a.indexOf("#",a.length-1)&&(a=a.substring(0,a.length-1));-1!==a.indexOf("/",a.length-1)&&(a=a.substring(0,a.length-1));return a}if(!a)return!1;var e=document.location.hash,k=document.location.search,g=document.location.href;window.top!==window.self&&(g=document.referrer);
b&&(k=b.indexOf("#"),-1===k&&(k=b.length),e=b.substring(b.indexOf("#"),b.length),k=b.substring(b.indexOf("?"),k),g=b);a=c(a);a=a.replace(/^(www\.)/g,"");a=d(a);g=c(g);g=g.replace(/^(www\.)/g,"");g=d(g);-1===a.indexOf("#")&&-1!==g.indexOf("#")&&(g=g.substring(0,g.length-e.length));-1===a.indexOf("?")&&-1!==g.indexOf("?")&&(g=g.substring(0,g.length-k.length));g=d(g);return g===a},isFormPage:function(){var a=window.Demandbase.Config.forms.emailFields||[];window.Demandbase.Config.forms.emailID&&a.push(window.Demandbase.Config.forms.emailID);
...
b,c,d,e,k){if(!a||/^(?:expires|max\-age|path|domain|secure)$/i.test(a))return!1;var g="";if(c)switch(c.constructor){case Number:g=Infinity===c?"; expires=Fri, 31 Dec 9999 23:59:59 GMT":"; max-age="+c;break;case String:g="; expires="+c;break;case Date:g="; expires="+c.toUTCString()}document.cookie=encodeURIComponent(a)+"="+encodeURIComponent(b)+g+(e?"; domain="+e:"")+(d?"; path="+d:"")+(k?"; secure":"");return!0},loadDebugFile:function(){this.loadScript(this.tokens.URL_DEBUG_FILE,"db_debug_lib");this.log("Loaded Debug library...")},
...
"none";b.appendChild(a);window.Demandbase.utils.log("ECT: added.")}},unpack:function(a){if(a){var b={gpid:0,cid:1,sid:2,ip:3,dmps:4};a=a.split(this.delim);this.values.gpid=a[b.gpid]||"";this.values.cid=a[b.cid]||"";this.values.sid=a[b.sid]||"";this.values.ip=a[b.ip]||"";this.values.dmps=a[b.dmps]||""}}},events:{add:function(a){try{var b=!0;if(this.isValid(a)){var c=a.type||window.Demandbase.utils.tokens.DFLT_EVENT_TYPE,d=a.elements,e=d.constructor;if(e===HTMLCollection||e===NodeList)for(var k in d)e=
!1,d.hasOwnProperty(k)&&(e=this._attachListener(d[k],c,a.listener),e||(b=!1,window.Demandbase.utils.log("Event not added to"+d[k])));else return this._attachListener(a.elements,c,a.listener)}else return window.Demandbase.utils.log("Event not added."),!1;return b}catch(g){window.Demandbase.utils.alert("Error: "+g+"\n"+g.stack)}},_attachListener:function(a,b,c){try{var d=!1;if(a)if("undefined"!==typeof jQuery&&a instanceof jQuery){if("undefined"!==typeof a.on)a.on(b,c);else a.bind(b,c);d=!0;window.Demandbase.utils.log("Event Listener bind to: "+
...
typeof a)c.log("IP API query cancelled - check auth key.");else{var d={},e="",k="undefined"!==typeof a?a:this.key,g="undefined"!==typeof b&&!1===b?"Demandbase.Ads.track":"Demandbase.IP._callback";this.useTestValue?e=this.testValue:"undefined"!==typeof c.ect.values.ip&&c.ect.values.ip&&(e=c.ect.values.ip);d={key:k,callback:g,query:e};c.log("Calling IP API...");c.loadScript(c.buildApiUrl(c.tokens.URL_IP_API,d),"db_ip_api")}}catch(f){window.Demandbase.utils.alert("IP API Error: "+f+" : "+f.stack)}},
...
(function(h){function f(b){if(a[b])return a[b].exports;var c=a[b]={exports:{},id:b,loaded:!1};h[b].call(c.exports,c,c.exports,f);c.loaded=!0;return c.exports}var a={};f.m=h;f.c=a;f.p="/dist/scripts";return f(0)})([function(h,f){window.Demandbase.Connectors.Google_Analytics={name:"Demandbase Universal Analytics Connector",version:"7.1.2",fields:window.Demandbase.Config.analytics.fieldMap||{},CompanyProfile:null,gType:"ua",trackerName:"",track:function(a){try{if(!a)throw"Error - no data passed to callback";
var b=window.Demandbase.Connectors.Google_Analytics,c=window.Demandbase.utils;a=c.flattenData(a);b._toGtmDl(a);b.CompanyProfile=a;b._detectG();b._setTrackerName();for(var d in b.fields)if(b.fields.hasOwnProperty(d)){var e=d,f=b.fields[d],g=c.getAttrValue(a,f);b._var(e,f,g.toString())}b._cEvent("Demandbase","API Resolution","IP API")}catch(h){window.Demandbase.utils.alert("GA Error: "+h+"\n"+h.stack),window.Demandbase.Connectors.Google_Analytics._cEvent("Demandbase","API Resolution","Callback Error")}},
...
(function(h){function f(b){if(a[b])return a[b].exports;var c=a[b]={exports:{},id:b,loaded:!1};h[b].call(c.exports,c,c.exports,f);c.loaded=!0;return c.exports}var a={};f.m=h;f.c=a;f.p="/dist/scripts";return f(0)})([function(h,f){window.Demandbase.Ads={name:"Demandbase Ad Connector",version:"4.2.2",pixels:window.Demandbase.Config.ads.pixels||{},conversionTriggers:window.Demandbase.Config.ads.conversionTriggers||{},track:function(a){try{window.Demandbase.Ads._log("tracked.")}catch(b){window.Demandbase.utils.alert("Ads Error: "+
